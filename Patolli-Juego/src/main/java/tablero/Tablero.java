...
public class Tablero implements Serializable {
 private LinkedList<Casilla> casillas;  // Lista enlazada de casillas
    ...
    // Inicializa el tablero con la cantidad de casillas según el aspa
    private void inicializarTablero() {
        for (int i = 0; i < cantidadCasillasAspa; i++) {
            Casilla nuevaCasilla = new Casilla(); 
            agregarCasilla(nuevaCasilla);  
        }
        // Llamamos al método para ordenar las casillas
